...
export const MOCK_MATCHES: MatchInfo[] = [
    {
        ...
        gender: "male",
        blue: { name: "Nguyễn Minh Nhật", team: "TP.HCM" },
        red: { name: "Trần Khắc Duy", team: "Hà Nội" },
...

    {
        ...
        gender: "male",
        blue: { name: "Lê Văn Tuấn", team: "Đà Nẵng" },
        red: { name: "Phạm Quốc Bảo", team: "Cần Thơ" },
...

    {
        ...
        gender: "female",
        blue: { name: "Nguyễn Thị Lan", team: "Bình Dương" },
        red: { name: "Võ Thị Thu Hương", team: "Đồng Nai" },
...

    {
        ...
        gender: "male",
        blue: { name: "Trần Đình Phúc", team: "Hà Nội" },
        red: { name: "Nguyễn Văn Thịnh", team: "TP.HCM" },
