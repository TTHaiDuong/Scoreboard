...
function WinnerCard(props: {
    ...
    return (
        ...
        >
            <div className={`flex-center w-[40px] h-[40px] rounded-full font-score text-[22px] font-bold
        ...
        <div className="flex flex-col gap-[16px]">
            ...
            <div className="flex gap-[10px]">
                <WinnerCard
                    ...
                    onClick={() => !isDone && setSelectedWinner("blue")}
                />
                <WinnerCard
                    side="red"
                    name={match.red.name}
                    isSelected={selectedWinner === "red"}
                    onClick={() => !isDone && setSelectedWinner("red")}
                />
            </div>
