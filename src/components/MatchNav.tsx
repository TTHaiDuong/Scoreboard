    ...
    return (
        <div className={`flex flex-col gap-[8px] p-[12px] rounded-[12px] border ${accent}`}>
            <div className="flex items-center gap-[8px]">
                <div className={`flex-center w-[28px] h-[28px] rounded-full font-score font-bold text-[16px] shrink-0
            ...
            <div className="grid grid-cols-2 gap-[8px]">
                ...
                <DarkInput
                    ...
                    placeholder="VIE"
                    onChange={v => props.onChange({ country: v || undefined })}
                />
            </div>
        </div>
    )
...
function AthleteRow(props: {
    ...
    return (
        <div className={`flex items-center gap-[10px] px-[16px] py-[12px]
            ...
            <div className={`flex-center w-[32px] h-[32px] rounded-full font-score font-bold text-[18px] shrink-0
                ${isBlue ? "bg-blue-600 text-white" : "bg-red-600 text-white"}`}>
                {props.roundWins}
            </div>
        ...
        <div className="flex flex-col gap-[14px]">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="text-[13px] text-white/40 active:text-white/70 transition-colors"
                >
                    Huỷ
                </button>
            </div>
...
function MatchListItem(props: {
    ...
    return (
        <button onClick={props.onClick}
            ...
            <span className="font-score font-bold text-[16px] text-white/60 w-[28px] shrink-0">
                {match.matchNo}
            </span>
            ...
            {(wins.blue > 0 || wins.red > 0) && (
                <span className="font-score text-[14px] text-white/50 shrink-0">
                    {wins.blue}:{wins.red}
                </span>
            )}
            ...
            <div className="flex items-center justify-between px-[4px]">
                ...
                <button onClick={() => setMode("search")}
                    ...
                    <div className="flex items-baseline gap-[4px]">
                        <span className="font-score font-bold text-[22px] text-white leading-none">
                            Trận {match.matchNo}
                        </span>
