...
function BreakdownStepper(props: {
    ...
    return (
        <div className={`flex items-center rounded-[6px] overflow-hidden text-[13px] font-semibold ${cls}`}>
            ...
            <span className="min-w-[22px] text-center font-score">{props.value}</span>
                    ...
                    <div key={row.key}
                        ...
                        <div className="flex items-center gap-[6px]">
                            {row.icon
                                ...
                                : <span className="w-[13px] text-center text-[10px] font-bold text-white/35">
                                    {row.pts || "GJ"}
                                </span>
                            }
                        ...
                        {/* Multiplier */}
                        <span className="text-center text-[10px] text-white/20 font-score">
    ...
    return (
        <>
            <div className={`flex flex-col rounded-[10px] transition-colors
                ...
                {/* Summary row */}
                <div className="flex items-center min-h-[44px] px-[4px] gap-[8px]">
                    ...
                    <span className={`w-[28px] text-center font-score text-[18px] leading-none
...
function ResetMatchButton(props: { onReset: () => void }) {
    ...
    if (!confirm) return (
        <button
            ...
            className="w-full mt-[4px] py-[8px] rounded-[10px] text-[12px] text-white/20
...
export default function RoundResults(props: {
    ...
    return (
        <div className="flex flex-col gap-[4px]">
            {/* Header */}
            <div className="flex items-center px-[4px] gap-[8px] pb-[4px] border-b border-white/10">
                <div className="w-[28px]" />
                <span className="w-[28px] text-center text-[11px] font-semibold text-blue-400">XANH</span>
                <span className="w-[12px]" />
                <span className="w-[28px] text-center text-[11px] font-semibold text-red-400">ĐỎ</span>
