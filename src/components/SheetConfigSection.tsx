    ...
    return (
        <div className="flex flex-col gap-[4px]">
            ...
            <input
                ...
                className={`w-full px-[12px] py-[9px] rounded-[10px] text-[14px]
    ...
    return (
        <div className="grid grid-cols-[1fr_1fr] gap-[8px] items-center
            ...
            <input
                ...
                value={props.column}
                onChange={e => props.onChange(e.target.value)}
                className="px-[8px] py-[5px] rounded-[6px] text-[12px] font-mono
        ...
        <div className="flex flex-col gap-[14px]">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-[8px]">
                    ...
                    <span className="text-[15px] font-semibold text-white">Google Sheets</span>
                </div>
